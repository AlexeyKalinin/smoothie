...
namespace Smoothie
{
    ...
    public class SmoothieUIButton : Button
    {
        ...
        [SerializeField, Range(-1, 10)] public int SelectAfterShown = -1;
        ...
        protected override void DoStateTransition(SelectionState state, bool instant)
        {
            ...
            smoothieUIElement.Animate(animationType, isShowAction: false, resetInterpolator: false,
                isStateChange: true);
        }
        ...
        public override void OnMove(AxisEventData eventData)
        {
            ...
            {
                smoothieUIElement?.Animate(moveAnimation, isShowAction: false, resetInterpolator: true,
                    isStateChange: true);
            }
